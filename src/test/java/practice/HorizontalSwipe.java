...
public class HorizontalSwipe extends TestBase
{
//		E:\\APK files\\APKFiles-1\\resources\\ApiDemos-debug.apk
	...
	public void test() throws MalformedURLException
	{
		...
		//swipe area
		By swipeArea=By.id("io.appium.android.apis:id/gallery");
		
		//horizontal swipe using swipe gesture
		cf.horizontalSwipeusingJavaScriptExecutor(swipeArea);
